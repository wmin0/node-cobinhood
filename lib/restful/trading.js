...
const placeLimitStopOrder = function(pair, side, price, size, stopPrice, source) { return (
  this.placeOrder(pair, 'limit_stop', side, price, size, stopPrice, source)
) }

const placeMarketStopOrder = function(pair, side, size, stopPrice, source) { return (
  this.placeOrder(pair, 'market_stop', side, '0', size, stopPrice, source)
) }
...
const modifyOrder = function(id, price, size) { return (
